...
document.body.insertBefore(this._completionListElement, document.body.firstChild);} else {
...
var element = this.get_element();if (element.readOnly) return;this._textBoxHasFocus = true;if (this._flyoutHasFocus) {
this._hideCompletionList();}
this._timer.set_enabled(true);},
_onKeyDown: function(ev) {
var k = ev.keyCode ? ev.keyCode : ev.rawEvent.keyCode;if (k === Sys.UI.Key.esc) {
if (this._popupBehavior == null || this._popupBehavior.get_visible())
ev.preventDefault();this._hideCompletionList();} else if (k === Sys.UI.Key.up) {
...
var element = this.get_element();if (element.readOnly) return;var text = (item && item.firstChild) ? item.firstChild.nodeValue : null;this._timer.set_enabled(false);var element = this.get_element();var control = element.control;if (control && control.set_text) {
