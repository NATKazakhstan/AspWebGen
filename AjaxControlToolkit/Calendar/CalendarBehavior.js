...
var elt = this.get_element();var id = this.get_id();var parentNode = this._popupBehaviorParentNode == null ? elt.parentNode : this._popupBehaviorParentNode;this._container = $common.createElementFromTemplate({
nodeName : "div",
properties : { id : id + "_container" },
cssClasses : [this._cssClass]
}, parentNode);this._popupDiv = $common.createElementFromTemplate({ 
nodeName : "div",
