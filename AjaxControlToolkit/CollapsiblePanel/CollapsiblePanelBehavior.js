...
if (e.oldDisplay) {
e.style.height = "1px";e.style.display = e.oldDisplay;} else {
...
if (this.get_element().style.height == "0px") return 0;return this.get_element().offsetHeight;},
set_TargetHeight: function(value) {
this.get_element().style.height = value + "px";this.raisePropertyChanged('TargetHeight');},
get_TargetWidth: function() {
if (this.get_element().style.width == "0px") return 0;return this.get_element().offsetWidth;},
