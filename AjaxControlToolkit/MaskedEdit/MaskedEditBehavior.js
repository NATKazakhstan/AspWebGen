...
this.AutoFormatDate();} else if (ClearText != "" && this._AutoComplete && this._MaskType == AjaxControlToolkit.MaskedEditType.Time) {
this.AutoFormatTime();} else if (ClearText != "" && this._AutoComplete && this._MaskType == AjaxControlToolkit.MaskedEditType.DateTime) {
this.AutoFormatDateTime();} else if (ClearText != "" && this._AutoComplete && this._MaskType == AjaxControlToolkit.MaskedEditType.Number) {
...
var wrapper = AjaxControlToolkit.TextBoxWrapper.get_Wrapper(this.get_element());if (!this.get_element().readOnly && (this._initialvalue != wrapper.get_Value() && !(this._initialvalue == this._EmptyMask && wrapper.get_Value() == "")) && evt) {
this._fireChanged();}
}
...
if (evt.target.readOnly) return true;var scancode = this._KeyCode(evt);if (scancode == 9) 
{
return true;}
if (scanCode == 13) {
...
if (evt.target.readOnly) return true;if (this._InLostfocus) {
this._onFocus(evt);}
...
else if (posmask.substring(poscur, poscur + 1).toUpperCase() == "K") {
filter = this._cyrillicCharLetters + this._cyrillicCharLetters.toLowerCase() + this._Filtered;}
else if (posmask.substring(poscur, poscur + 1) == "?") {
filter = "";}
else {
return false;}
