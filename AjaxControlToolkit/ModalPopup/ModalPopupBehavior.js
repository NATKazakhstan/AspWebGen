...
AjaxControlToolkit.ModalPopupBehavior.initializeBase(this, [element]);this._PopupControlID = null;this._PopupDragHandleControlID = null;this._BackgroundCssClass = null;this._DropShadow = false;this._Drag = false;this._OkControlID = null;this._CancelControlID = null;this._OnOkScript = null;this._OnCancelScript = null;this._xCoordinate = -1;this._yCoordinate = -1;this._repositionMode = AjaxControlToolkit.ModalPopupRepositionMode.RepositionOnWindowResizeAndScroll;this._backgroundElement = null;this._foregroundElement = null;this._relativeOrAbsoluteParentElement = null;this._popupElement = null;this._dragHandleElement = null;this._showHandler = null;this._okHandler = null;this._cancelHandler = null;this._scrollHandler = null;this._resizeHandler = null;this._windowHandlersAttached = false;this._dropShadowBehavior = null;this._dragBehavior = null;this._isIE6 = false;this._saveTabIndexes = new Array();this._saveDesableSelect = new Array();this._saveOverflowAutoNode = new Array();this._tagWithTabIndex = new Array('A','AREA','BUTTON','INPUT','OBJECT','SELECT','TEXTAREA','IFRAME');}
AjaxControlToolkit.ModalPopupBehavior.prototype = {
initialize: function() {
AjaxControlToolkit.ModalPopupBehavior.callBaseMethod(this, 'initialize');this._isIE6 = true;if (this._PopupDragHandleControlID)
...
this._bodyScroll = document.body.scroll;document.body.scroll = "";var positioning = this.get_repositionMode();if (((positioning === AjaxControlToolkit.ModalPopupRepositionMode.RepositionOnWindowScroll) ||
...
document.body.scroll = this._bodyScroll;},
show: function() {
...
Array.clear(this._saveOverflowAutoNode);i = 0;var tempNode = this._foregroundElement.parentNode;while (tempNode != document.documentElement) {
if (tempNode.style.overflow == "auto" || tempNode.style.overflow == "hidden") {
this._saveOverflowAutoNode[i] =
{
tag: tempNode,
scrollLeft: tempNode.scrollLeft,
scrollTop: tempNode.scrollTop,
overflow: tempNode.style.overflow
}
tempNode.style.overflow = "visible";i++;}
tempNode = tempNode.parentNode;}
this.disableTab();this._layout();this.raiseShown(Sys.EventArgs.Empty);},
disableTab: function() {
...
this._saveDesableSelect[i] = { tag: tagElements[k], visib: $common.getCurrentStyle(tagElements[k], 'visibility') };i++;}
}
}
},
restoreTab: function() {
...
return false;}
this._hideImplementation();for (var k = 0;k < this._saveOverflowAutoNode.length;k++) {
var element = this._saveOverflowAutoNode[k].tag;if (element != null) {
element.style.overflow = this._saveOverflowAutoNode[k].overflow;element.scrollLeft = this._saveOverflowAutoNode[k].scrollLeft;element.scrollTop = this._saveOverflowAutoNode[k].scrollTop;}
}
Array.clear(this._saveOverflowAutoNode);this.raiseHidden(Sys.EventArgs.Empty);return true;},
...
this._foregroundElement.style.left = '0px';} else {
if (this._isIE6) {
...
this._foregroundElement.style.top = '0px';} else {
if (this._isIE6) {
...
var foregroundLocation = $common.getLocation(this._foregroundElement);var relativeParentLocation = $common.getLocation(this._relativeOrAbsoluteParentElement);var getLocationXCoord = foregroundLocation.x;var scrollLeft = (document.documentElement.scrollLeft ? document.documentElement.scrollLeft : document.body.scrollLeft);var scrollTop = (document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop);if (getLocationXCoord != xCoord) {
if (xCoord - relativeParentLocation.x >= 0)
this._foregroundElement.style.left = (xCoord - relativeParentLocation.x) + 'px';else
this._foregroundElement.style.left = '0px';}
var getLocationYCoord = foregroundLocation.y;if (getLocationYCoord != yCoord) {
if (yCoord - relativeParentLocation.y >= 0)
this._foregroundElement.style.top = (yCoord - relativeParentLocation.y) + 'px';else
this._foregroundElement.style.top = '0px'
}
}
},
_layoutBackgroundElement: function () {
var $c = $(this._backgroundElement);$c.width($(window).width());$c.height($(window).height());$c.css('position', 'fixed');},
