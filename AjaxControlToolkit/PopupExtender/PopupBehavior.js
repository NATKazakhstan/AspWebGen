...
setupPopup : function() {
var element = this.get_element();var bounds;if (Sys.Browser.agent == Sys.Browser.InternetExplorer && Sys.Browser.version <= 7) {
bounds = this.getBounds();bounds.x += document.body.scrollLeft;bounds.y += document.body.scrollTop;}
else {
bounds = this.getBounds();}
$common.setLocation(element, bounds);this.adjustPopupPosition(bounds);element.style.zIndex = 1000;this.addBackgroundIFrame();},
_hidePopup : function() {
