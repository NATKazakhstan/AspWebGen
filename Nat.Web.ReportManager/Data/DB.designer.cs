...
namespace Nat.Web.ReportManager.Data
{
    ...
    partial void OnDeviationsFromThePeriodDayChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ReportSubscriptions_ReportSubscriptions_Params_refReportSubscriptions", Storage="_ReportSubscription_refReportSubscriptions", ThisKey="refReportSubscriptions", OtherKey="id", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DIC_ReportTimePeriodsParameters_ReportSubscriptions_Params_refReportTimePeriodsPa" +
			"rameters", Storage="_DIC_ReportTimePeriodsParameter_refReportTimePeriodsParameters", ThisKey="refReportTimePeriodsParameters", OtherKey="id", IsForeignKey=true)]
    ...
    partial void OnconstantsChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[values]", Storage="_values", DbType="VarBinary(MAX)", CanBeNull=true, UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_constants", DbType="VarBinary(MAX)", CanBeNull=true, UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ReportSubscriptions_ReportSubscriptions_Params_refReportSubscriptions", Storage="_ReportSubscriptions_Params_refReportSubscriptions", ThisKey="id", OtherKey="refReportSubscriptions")]
    ...
    partial void OnrefHistoryChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DIC_ReportTimePeriodsParameters_DIC_ReportTimePeriodsParameters_refHistory", Storage="_DIC_ReportTimePeriodsParameters_refHistory", ThisKey="id", OtherKey="refHistory")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DIC_ReportTimePeriodsParameters_DIC_ReportTimePeriodsParameters_refHistory", Storage="_DIC_ReportTimePeriodsParameter_refHistory", ThisKey="refHistory", OtherKey="id", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DIC_ReportTimePeriodsParameters_ReportSubscriptions_Params_refReportTimePeriodsPa" +
			"rameters", Storage="_ReportSubscriptions_Params_refReportTimePeriodsParameters", ThisKey="id", OtherKey="refReportTimePeriodsParameters")]
    ...
    partial void OnidChanging(long value);
    partial void OnidChanged();
    partial void OnpluginFullNameChanging(string value);
    partial void OnpluginFullNameChanged();
    partial void OnreportNameChanging(string value);
    partial void OnreportNameChanged();
    partial void OnhasWatermarkChanging(bool value);
    partial void OnhasWatermarkChanged();
    ...
    partial void OnisVisibleChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_pluginFullName", DbType="nvarchar(255)", CanBeNull=false)]
		public string pluginFullName
		{
			...
			set
			{
				if ((this._pluginFullName != value))
				{
					this.OnpluginFullNameChanging(value);
					this.SendPropertyChanging();
					this._pluginFullName = value;
					this.SendPropertyChanged("pluginFullName");
					this.OnpluginFullNameChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_reportName", DbType="nvarchar(255)", CanBeNull=false)]
		public string reportName
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_hasWatermark", DbType="bit")]
		public bool hasWatermark
		{
			...
			set
			{
				if ((this._hasWatermark != value))
				{
					this.OnhasWatermarkChanging(value);
					this.SendPropertyChanging();
					this._hasWatermark = value;
					this.SendPropertyChanged("hasWatermark");
					this.OnhasWatermarkChanged();
				}
			}
		}
