...
namespace Nat.Web.ReportManager
{
    ...
    internal class ParamReportSubscriptionsP3 : ParamReportSubscriptions
    {
        internal override DateTime[] Calculate()
        {
            ...
            {
                d[0] = DateTimeHelper.GetFirstDayQuarter(this.DateNext.Value);
                d[1] = this.RowParam.CreateOnTheDayPublication
                           ? this.DateNext.Value
                           : DateTimeHelper.GetLastDayQuarter(this.DateNext.Value);
