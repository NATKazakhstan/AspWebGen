...
namespace Nat.Web.ReportManager
{
    ...
    internal class ParamReportSubscriptionsP4 : ParamReportSubscriptions
    {
        internal override DateTime[] Calculate()
        {
            ...
            {
                d[0] = DateTimeHelper.GetFirstDayMonths(this.DateNext.Value);
                d[1] = this.RowParam.CreateOnTheDayPublication
                           ? this.DateNext.Value
                           : DateTimeHelper.GetLastDayMonths(this.DateNext.Value);
